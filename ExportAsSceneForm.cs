...
namespace CaravelEditor
{
    public partial class ExportAsSceneForm : Form
    {
        ...
        public ExportAsSceneForm(string currProject, string[] resourceBundles, int currSceneViewportWidth, int currSceneViewportHeight)
        {
            ...
            if (currSceneViewportWidth > 0)
            {
                m_iViewPortX = currSceneViewportWidth;
                widthTextBox.Text = m_iViewPortX.ToString();
            }

            if (currSceneViewportHeight > 0)
            {
                m_iViewPortY = currSceneViewportHeight;
                heightTextBox.Text = m_iViewPortY.ToString();
            }
        }
